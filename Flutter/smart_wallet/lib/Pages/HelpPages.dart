    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(child: Column(
        ...
        children: [
          ...
          buildText('শুরুতে Default নামে একটা Market যুক্ত থাকবে। Market অপশনে গেলে দেখা যাবে কোনটা এখন Active আছে। ডান পাশের নিচের দিকে Plus Button এ চাপ দিলের Market এর নাম সেট করার অপশন আসবে। এর পর Save Button এ চাপ দিলেই ঐ নামে নতুন একটা Market তৈরী হয়ে যাবে এবং নতুন Market টি Active থাকবে।'),
          ...
          buildText('ডান পাশের উপরের দিকে Balance লিখার উপর চাপ দিলে বর্তমান টাকার পরিমান সহ মোট খরচ, মোট জমা সব হিযাব দেখা যাবে। আমার ঐ একই জায়গায় চাপ দিলেই সকল টাকার পরিমান hide হয়ে যাবে।'),
          ...
          buildBoldText('বর্ননা কিভাবে যুক্ত করবো?'),
          buildText('Home Page এ Plus Button এ চাপ দিলে বর্ননা যুক্ত করার অশন আসবে। সেখানে ছোট বর্ননা ও বড় বর্নন জন্য অপশন থাকবে। বড় বর্ননা না দিলে কোন সমস্যা হবে না। এই বর্ননা টা কতটা গুরুত্বপুর্ন না সেট করে সভ করলেই হবে।'),
          buildBoldText('বর্ননা Edit করবো কিভাবে?'),
          buildText('বর্ননার উপর চাপ দিয়ে রাখলে Edit চলে আসবে। এখন থেকে পরিবর্তন করা যাবে।'),
          ...
          buildText('হিসাব এর উপর চাপ দিয়ে রাখলে Delete এর নিশয়তা চাবে। এখন থেকে I am sure Button এ চাপ দিলে হিসাবটি মুছে যাবে।'),
          ...
          buildText('User Page এ login করার মাধ্যমে সকল তথ্য অনলাইলে জমা রাখা যাবে। এবং পরে ব্যাক-আপ পাওয়া যাবে। এবং একজন ব্যাবহার কারী নির্দিষ্ট Market অন্য এক বা একাধিক ব্যাবহার কারির সাথে শেয়ার করেতে পারবে'),
